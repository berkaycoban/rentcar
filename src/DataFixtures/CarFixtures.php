...
class CarFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        foreach ($this->getCarData() as [$brand, $model, $year, $fuel, $gear, $class, $seats, $km, $daily_price, $daily_max_km, $min_license_year, $min_driver_age, $src, $alt, $company]) {
            $car = new Car();
            $car->setBrand($brand)
                ->setModel($model)
                ->setYear($year)
    ...
    {
        return [
            // $carData = [$brand, $model, $year, $fuel, $gear, $class, $seats, $km, $daily_price, $daily_max_km, $min_license_year, $min_driver_age, $src, $alt, $company];
            ['Audi', 'A3', '2021', 'Diesel', self::AUTOMATIC, self::PREMIUM_CLASS, 4, 0, 900, 500, 3, 25, 'a3.webp', 'Audi A3', CompanyFixtures::REFERENCE_NAME],
            ['Audi', 'A8', '2021', 'Diesel', self::AUTOMATIC, self::PREMIUM_CLASS, 4, 0, 900, 500, 3, 25, 'a3.webp', 'Audi A3', CompanyFixtures::REFERENCE_NAME_1],
            ['Renault', 'Clio 1.5', '2019', 'Diesel', self::MANUEL, self::ECONOMIC_CLASS, 4, 1000, 300, 300, 1, 20, 'clio.png', 'Clio', CompanyFixtures::REFERENCE_NAME],
            ['Fiat', 'Egea 1.3', '2020', 'Gasoline', self::MANUEL, self::ECONOMIC_CLASS, 4, 2000, 400, 300, 1, 20, 'egea.png', 'Egea', CompanyFixtures::REFERENCE_NAME_1],
            ...
            ['BMW', '320i', '2020', 'Diesel', self::SEMI_AUTO, self::PREMIUM_CLASS, 4, 100, 700, 300, 2, 21, '320i.png', '320', CompanyFixtures::REFERENCE_NAME],
            ['Volvo', 'S90', '2019', 'Gas & LPG', self::AUTOMATIC, self::PREMIUM_CLASS, 4, 2000, 700, 400, 2, 22, 's90.png', 'S90',CompanyFixtures::REFERENCE_NAME],
