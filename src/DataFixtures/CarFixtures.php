...
class CarFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getCarData(): array
    {
        return [
            ...
            ['Audi', 'A3', '2021', 'Diesel', self::AUTOMATIC, self::PREMIUM_CLASS, 4, 0, 900, 500, 3, 25, 'a3.webp', 'Audi A3', CompanyFixtures::REFERENCE_NAME, 'car1'],
            ['Audi', 'A8', '2021', 'Diesel', self::AUTOMATIC, self::PREMIUM_CLASS, 4, 0, 900, 500, 3, 25, 'a3.webp', 'Audi A3', CompanyFixtures::REFERENCE_NAME_1, 'car2'],
